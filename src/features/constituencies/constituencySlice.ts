...
const initialState: ConstituencyState = {
  cache: {},
  loading: {},
  error: {},
};
...
export const { clearCache, clearCacheEntry } = constituencySlice.actions;
export const constituencyReducer = constituencySlice.reducer;
